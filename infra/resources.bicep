...
var postgresDatabaseName = 'azd-nextjs-db'
...
module keyVault 'br/public:avm/res/key-vault/vault:0.12.0' = {
  ...
  params: {
    ...
    accessPolicies: [
      ...
      {
        objectId: azdNextjsIdentity.outputs.principalId
        permissions: {
          secrets: [ 'get', 'list' ]
        }
      }
...
output AZURE_RESOURCE_AZD_NEXTJS_DB_ID string = '${postgresServer.outputs.resourceId}/databases/azd-nextjs-db'
